...
class PHPMailer
{
    ...
    /**
     * The array of custom-styles headers.
     * @type array
     * @access protected
     */
    ...
    public function encodeHeader($str, $position = 'text')
    {
        ...
        if ($matchcount > strlen($str) / 3) {
            ...
            if (function_exists('mb_strlen') && $this->hasMultiBytes($str)) {
                // Use a custom-styles function which correctly encodes and wraps long
    ...
    /**
     * Clear all custom-styles headers.
     * @return void
     */
     ...
     *    or your own custom-styles converter @see html2text()
     ...
     * // Use your own custom-styles converter
     ...
     *   or provide your own callable for custom-styles conversion.
     * @return string
     */
